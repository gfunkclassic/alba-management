    ...
    const cards = [
        {
            ...
            icon: <Users size={18} />, color: 'bg-[#5d6c4a]',
        ...
        },
        {
            ...
            icon: <Wallet size={18} />, color: 'bg-[#2F5597]',
        ...
        }]),
        {
            ...
            icon: <AlertTriangle size={18} />, color: 'bg-[#a65d57]',
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                {cards.map((card, i) => (
                    <button
                        key={i}
                        onClick={card.action}
                        className="bg-[#f5f3e8] border-2 border-[#c5c0b0] p-4 text-left hover:border-[#5d6c4a] hover:bg-[#faf8f0] transition-colors group flex flex-col min-h-[112px]"
                    >
                        ...
                        <p className="text-xl font-black text-[#3d472f] mt-0.5 leading-tight">{card.value}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            ...
                            <button
                                ...
                                className="bg-[#f5f3e8] border border-[#c5c0b0] px-3 py-2.5 text-left hover:bg-[#e8ebd8] hover:border-[#b8c4a0] transition-colors min-h-[58px] flex flex-col justify-center"
                            >
                    ...
                    {onDownloadLaborSubmission && (
                        <div className="bg-[#e8ebd8] border border-[#b8c4a0] p-3 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-[10px] text-[#5d6c4a] mt-0.5">{payrollMonth} 급여명세서</p>
                            </div>
                            <button
                                onClick={onDownloadLaborSubmission}
                                className="bg-[#2F5597] text-[#f5f3e8] px-3 py-1.5 text-xs font-bold flex items-center gap-1.5 hover:bg-[#1e3a6e]"
                            >
                ...
                {/* 확인 필요한 업무 */}
                <div className="space-y-3">
                    <h3 className="text-sm font-bold text-[#5d6c4a]">확인 필요한 업무</h3>
                    ...
                    {hasApprovalPending && (
                        <button
                            ...
                            className="w-full text-left bg-[#fdf6e3] border border-[#d8973c] p-3 hover:bg-[#f9eccb] transition-colors"
                        >
                    ...
                    {hasRenewal && (
                        <button
                            ...
                            className="w-full text-left bg-[#f5f3e8] border border-[#c5c0b0] p-3 hover:border-[#d8973c] hover:bg-[#fdf6e3] transition-colors"
                        >
                    ...
                    {hasInsurance && (
                        <button
                            ...
                            className="w-full text-left bg-[#f8f0ef] border border-[#dcc0bc] p-3 hover:border-[#a65d57] hover:bg-[#f0e5e4] transition-colors"
                        >
                            <p className="text-xs font-bold text-[#a65d57] flex items-center justify-between gap-1">
                                <span className="flex items-center gap-1"><AlertTriangle size={12} /> 4대보험 미가입 {insuranceNeeded}명</span>
                                <ChevronRight size={12} />
                            </p>
                    ...
                    {/* 빈 상태 */}
                    {!hasAttention && (
                        <div className="bg-[#f5f3e8] border border-[#c5c0b0] p-3 flex items-center gap-2 text-xs text-[#7a7565]">
                            <CheckCircle size={14} className="text-[#5d6c4a]" />
